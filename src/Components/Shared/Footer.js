        ...
        <div>
          <div>
            <div className="flex flex-row">
              <img className="w-[150px] mr-8 " src={austLogo} alt="" />
            ...
            <div className="mt-6">
              <h1 className="text-2xl uppercase">social media</h1>
              ...
              <div className="flex items-center  justify-start mt-2 text-white">
                ...
                <a href="https://www.facebook.com/" target="blank">
                  <MdEmail className="mx-1 h-[38px] w-[36px]  hover:scale-125"></MdEmail>
                </a>
                <a href="https://www.facebook.com/" target="blank">
