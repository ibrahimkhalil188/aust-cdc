...
const RegisterSlider = () => {
  return (
   ...
   <div>
   <h1 className="text-3xl lg:text-[80px] text-center font-bold uppercase"><span className="text-white">Join the League of</span> <span className="text-secondary">Leaders</span></h1>
